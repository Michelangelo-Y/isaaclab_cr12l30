...
All the environments are registered in the `isaaclab_cr12l30` extension. They start
...
import isaaclab_cr12l30.tasks  # noqa: F401


def main():
    """Print all environments registered in `isaaclab_cr12l30` extension."""
