...
from .isaaclab_cr12l30_marl_env_cfg import IsaaclabCr12l30MarlEnvCfg


class IsaaclabCr12l30MarlEnv(DirectMARLEnv):
    cfg: IsaaclabCr12l30MarlEnvCfg

    def __init__(self, cfg: IsaaclabCr12l30MarlEnvCfg, render_mode: str | None = None, **kwargs):
